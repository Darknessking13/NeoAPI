...
function decorateRequest(req, appInstance) {
    ...
    Object.defineProperty(req, 'log', {
        get() {
            if (!this._logger) {
                this._logger = appInstance._createLogger('Request', { id: this.id });
            }
            return this._logger;
        },
        configurable: true
...
function decorateResponse(res, appInstance) {
    ...
    Object.defineProperty(res, 'log', {
        get() {
            if (!this._logger) {
                this._logger = appInstance._createLogger('Response', { id: this.req?.id });
            }
            return this._logger;
        },
        configurable: true
...
class ZyroAPI extends EventEmitter {
    constructor(options = {}) {
        ...
        this.log = this._createLogger('ZyroAPI Core');
